# Folha de Consulta do GitHub [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
Uma coleção de recursos legais, escondidos (ou nem tanto assim) do Git e do GitHub. Essa *folha de consulta* foi inspirada nas paletras de [Zach Holman](https://github.com/holman): [Git and GitHub Secrets](http://confreaks.tv/videos/aloharuby2012-git-and-github-secrets) na Aloha Ruby Conference 2012 ([slides](https://speakerdeck.com/holman/git-and-github-secrets)) e [More Git and GitHub Secrets](https://vimeo.com/72955426) na WDCNZ 2013 ([slides](https://speakerdeck.com/holman/more-git-and-github-secrets)).

*URL encurtada: [`http://git.io/sheet`](http://git.io/sheet)*
